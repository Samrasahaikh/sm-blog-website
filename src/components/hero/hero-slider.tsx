...
export function CarouselPlugin() {
  ...
  return (
    <Carousel
      ...
      className="lg:w-[1200px] md:w-[750px] md:h-[300px] lg:h-[500px] w-[350px] h-[250px] max-w-screen-2xl mx-auto"
            ...
            <div className="p-1">
              <Card className="relative overflow-hidden">
                ...
                <Image
                  ...
                  width={500}
                  height={500}
                  className="object-cover rounded-md lg:h-[490px] lg:w-[1500px] md:h-[290px] md:w-[750px] h-[250px] w-[350px]"
                />

                {/* Text Overlay */}
                <div className="absolute inset-0 items-center justify-center bg-black bg-opacity-50 ">
                    <div className="justify-center items-center lg:h-[310px] h-[210px] w-[250px] p-2 md:w-[500px] md:ml-[150px] lg:ml-[350px] lg:mt-[130px] mt-6 ml-16 bg-black bg-opacity-50">
